...
export const HomeFeed = () => {
  ...
  const { data: feedData, isLoading, fetchNextPage, hasNextPage, isFetchingNextPage } = useQuery({
    queryKey: ["feed"],
  ...
  const posts = feedData?.pages.flatMap((page) => page.data.posts) || [];
  ...
  return (
    <div className="px-4 pt-4 pb-32 space-y-4 animate-fade-in">
      {/* Header */}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-1.5">
                        ...
                        {/* Add verified badge logic if needed */}
                      </div>
                    </div>
                  </div>
